...
export const mockSubjects: Subject[] = [
  ...
  { id: 'mp',  user_id: 'u1', name: '医学統合プログラム３・生体システムの概念', requirement_type: 'TWO_THIRDS', count_tardiness_as: 0.5, ignore_excused: true, color: '#8b5cf6', created_at: '', updated_at: '' },
...
const SCHEDULE: Row[] = [
  ...
  // 10/08-10/14 授業なし / 10/12 スポーツの日
  // 10/15-10/20 試験期間

  // ══════════ Ⅲ学期 ══════════
  // 科学的探究3（10/21〜12/22）は下の関数で生成
...
// ─── 科学的探究3 の日程を生成（10/21〜12/22）───────────────────
function researchSchedule(): Row[] {
  const holidays = new Set([
    '2026-10-29', '2026-10-30', '2026-10-31', // 医獣祭
    '2026-11-01', '2026-11-02',                // 後片付け・医獣祭
    '2026-11-03',                              // 文化の日
    '2026-11-23',                              // 勤労感謝の日
  ])
  const rows: Row[] = []
